...
public final class SewaSetuStatusMapper {
    ...
    static {
        ...
        APPLICATION_STATUS_TO_SEWA_SETU.put("FORWARDED_TO_TECHNICAL_ENGINEER_GP", "F");
        APPLICATION_STATUS_TO_SEWA_SETU.put("FORWARDED_TO_TECHNICAL_ENGINEER_MB", "F");
        APPLICATION_STATUS_TO_SEWA_SETU.put("FORWARDED_TO_ZONAL_OFFICER", "F");
        APPLICATION_STATUS_TO_SEWA_SETU.put("FORWARDED_TO_ASSOCIATE_PLANNER", "F");

        // Query Sent – sent back to citizen
        APPLICATION_STATUS_TO_SEWA_SETU.put("SEND_TO_CITIZEN", "QS");

        // Pending – various pending states (mapped to P)
        ...
        APPLICATION_STATUS_TO_SEWA_SETU.put("PENDING_CHAIRMAN_PRESIDENT_GP", "P");
        APPLICATION_STATUS_TO_SEWA_SETU.put("PENDING_CHAIRMAN_PRESIDENT_MB", "P");
        ...
        APPLICATION_STATUS_TO_SEWA_SETU.put("PENDING_DSC", "P");
        APPLICATION_STATUS_TO_SEWA_SETU.put("PENDING_FINAL_DSC", "P");
        APPLICATION_STATUS_TO_SEWA_SETU.put("PENDING_GMDA_ENGINEER", "P");
        APPLICATION_STATUS_TO_SEWA_SETU.put("PENDING_TOWNPLANNER", "P");
        APPLICATION_STATUS_TO_SEWA_SETU.put("PENDING_CEO", "P");
        APPLICATION_STATUS_TO_SEWA_SETU.put("PENDING_COMMISSIONER", "P");

        // Submitted / Citizen action (mapped to S)
